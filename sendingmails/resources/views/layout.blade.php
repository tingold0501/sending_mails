                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-item active">
                        <a href="index.html" class="menu-link">
                            <i class="fa-solid fa-house menu-icon text-sm"></i>
                            <div data-i18n="Analytics">Start</div>
                        </a>
                    </li>

                    <li class="menu-item ">
                        <a href="index.html" class="menu-link">
                            <i class="fa-solid fa-chart-line menu-icon text-sm"></i>
                    ...
                    <li class="menu-item">
                        <a href="javascript:void(0);" class="menu-link menu-toggle">
                            <i class="fa-solid fa-user-group menu-icon text-sm"></i>
                            <div data-i18n="Layouts">Audience</div>
                        </a>
                        <ul class="menu-sub">
                            <li class="menu-item">
                                <a href="{{ route('campaign') }}" class="menu-link">
                                    <div data-i18n="Without menu">Contract</div>
                                </a>
                            </li>
                            <li class="menu-item">
                            ...
                            <li class="menu-item">
                                <a href="{{ route('table') }}" class="menu-link">
                                    <div data-i18n="Container">Landings Pages</div>
                                </a>
                            </li>
                    ...
                    <li class="menu-item">
                        <a href="javascript:void(0);" class="menu-link menu-toggle">
                            <i class="fa-solid fa-paper-plane menu-icon text-sm"></i>
                            <div data-i18n="Layouts">Campaign</div>
                        </a>
                        <ul class="menu-sub">
                            <li class="menu-item">
                                <a href="{{ route('campaign') }}" class="menu-link">
                                    <div data-i18n="Without menu">All Campaign</div>
                                </a>
                            </li>
                            <li class="menu-item">
                                <a href="{{ route('contract') }}" class="menu-link">
                                    <div data-i18n="Without navbar">Email Templates</div>
                                </a>
                            </li>
                        </ul>
                    </li>
                            ...
                            <li class="nav-item navbar-dropdown dropdown-user dropdown">
                                <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);"
                                    ...
                                    <div class="avatar avatar-online">
                                        ...
                                        <img src="{{ Auth::user()->avatar }}" class="rounded" alt="Default Avatar">
                                    </div>
                                </a>
